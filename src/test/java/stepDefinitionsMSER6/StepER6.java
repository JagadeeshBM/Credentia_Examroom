...
public class StepER6 {
    ...
    public void click_on_Start_New_Application() throws IOException {
        ...
        File trg = new File(".\\screenshots\\homepage_MSER6.png");
        FileUtils.copyFile(src, trg);
    }

    @And("Click on Eligibility Route{int}")
    public void clickOnEligibilityRoute(int arg0) throws IOException {
        this.driver.findElement(By.xpath("//body//exai-root//button[5]")).click();
        TakesScreenshot ts = (TakesScreenshot)this.driver;
        File src = (File)ts.getScreenshotAs(OutputType.FILE);
        File trg = new File(".\\screenshots\\MSER6_ER_Validation.png");
        FileUtils.copyFile(src, trg);
    }
    ...
    @When("Candidate Fill the Application Form_SECTION {int}_CERTIFICATE INFORMATION_Certificate Number")
    public void candidate_fill_the_application_form_section__certificate_information_certificate_number(Integer int1)
    {
        driver.findElement(By.xpath("//input[@id='d8b8b08fa4484251987aaf5e68d5bfe9']")).sendKeys("24252624");

    }
    @When("Candidate Fill the Application Form_SECTION {int}_CERTIFICATE INFORMATION_Date Certification was Revoked")
    public void candidate_fill_the_application_form_section__certificate_information_date_certification_was_revoked(Integer int1) {
        ...
        calender.click();
//button[@aria-label='Open calendar']//span[@class='mat-button-wrapper']//*[name()='svg']
    ...
    @When("Candidate Fill the Application Form_SECTION {int}-CERTIFICATE INFORMATION_Please upload a copy of your criminal background check\\(background check must be within the last {int} weeks from date of application)")
    public void candidate_fill_the_application_form_section_certificate_information_please_upload_a_copy_of_your_criminal_background_check_background_check_must_be_within_the_last_weeks_from_date_of_application(Integer int1, Integer int2) throws InterruptedException, IOException {

        WebElement uploaddocument = this.driver.findElement(By.xpath("//dynamic-material-form-control[6]//div[1]//exai-dynamic-file-upload-control[1]//exai-file-upload-control[1]//div[1]//button[1]"));
        uploaddocument.click();
        Thread.sleep(1000L);
        Runtime.getRuntime().exec("C:\\Autoitfile\\fileupload.exe D:\\Document\\Noodles-MSLocations_Address.pdf");
        Thread.sleep(1000L);
    }
    @When("Candidate Fill the Application Form_SECTION {int}_CERTIFICATE INFORMATION_Please upload {int} references")
    public void candidate_fill_the_application_form_section__certificate_information_please_upload_references(Integer int1, Integer int2) throws InterruptedException, IOException {
        WebElement uploaddocument = this.driver.findElement(By.xpath("//dynamic-material-form-control[8]//div[1]//exai-dynamic-file-upload-control[1]//exai-file-upload-control[1]//div[1]//button[1]"));
        uploaddocument.click();
        Thread.sleep(1000L);
        Runtime.getRuntime().exec("C:\\Autoitfile\\fileupload.exe D:\\Document\\Noodles-MSLocations_Address.pdf");
        Thread.sleep(1000L);
    ...
    public void select_ACCOMMODATIONS_as_No() throws InterruptedException {
        ...
        Thread.sleep(800L);
        this.driver.findElement(By.xpath("//label[@for='mat-radio-14-input']//span[@class='mat-radio-inner-circle']")).click();

////label[@for='mat-radio-35-input']//span[@class='mat-radio-inner-circle']

        //label[@for='mat-radio-35-input']//span[@class='mat-radio-outer-circle']

        //<span class="mat-radio-inner-circle"></span>

        //*[@id="mat-radio-35"]/label/span[1]/span[1]
       // /html/body/exai-root/exai-custom-layout/exai-layout/div/mat-sidenav-container/mat-sidenav-content/main/exai-application/div[2]/div[1]/div/exai-form-builder/div/exai-dynamic-form-component/div/div/mat-card/div/mat-accordion/mat-expansion-panel[2]/div/div/div[2]/form/dynamic-material-form/dynamic-material-form-control/div/dynamic-material-form-group/div/dynamic-material-form-control[2]/div/dynamic-material-radio-group/mat-radio-group/mat-radio-button[2]/label/span[1]/span[1]
    ...
    public void candidate_can_view_confirmation_message(String string) throws InterruptedException, IOException {
        TakesScreenshot ts = (TakesScreenshot)this.driver;
        File src = (File)ts.getScreenshotAs(OutputType.FILE);
        File trg = new File(".\\screenshots\\MSER6_AppSubmitted_CR.png");
        FileUtils.copyFile(src, trg);
    }

    //Approve by State client
    ...
    @When("STClient opens URL {string}")
    public void st_client_opens_url(String string)

    {
        this.driver.get("https://credentiauat.examroom.ai/");
    }

    @When("STClient click on GetStarted button")
    public void st_client_click_on_get_started_button()

    {
        this.driver.findElement(By.xpath("/html/body/main/div/div/div[2]/div/div/a")).click();
    }

    @When("STClient Enters Email as {string} and password as {string}")
    public void st_client_enters_email_as_and_password_as(String string, String string2)

    {
        this.driver.findElement(By.xpath("//*[@id=\"mat-input-0\"]")).sendKeys(new CharSequence[]{"jmstatems@mailinator.com"});
        this.driver.findElement(By.xpath("//*[@id=\"mat-input-1\"]")).sendKeys(new CharSequence[]{"Exam@123"});
    }

    @When("STClient click on login button")
    public void st_client_click_on_login_button() throws InterruptedException
    {
        this.driver.findElement(By.xpath("/html/body/exai-root/exai-login/div/div/form/button")).click();
        Thread.sleep(50500L);
    }

    @When("STClient click on Manage Applications")
    public void st_client_click_on_manage_applications() throws InterruptedException
    {
        this.driver.findElement(By.xpath("//span[@class='item-label ng-tns-c298-5']")).click();
        Thread.sleep(20000L);
        //a[@class='mat-ripple item ng-tns-c298-5 ng-star-inserted active']
        //span[@class='item-label ng-tns-c298-5']
        //button[@class='mat-focus-indicator btn-1 mat-button mat-button-base mat-primary']
        //span[@class='item-label ng-tns-c298-5']
    }

    @When("STClient Search with candidate name")
    public void st_client_search_with_candidate_name() throws InterruptedException
    {
        this.driver.findElement(By.xpath("//input[@placeholder='Search']")).sendKeys(new CharSequence[]{"Appa B Mulimani"});
        Thread.sleep(1000L);
    }

    @When("STClient click on Action button for candidate")
    public void st_client_click_on_action_button_for_candidate() throws InterruptedException
    {
    ...
    public void click_on_approve_button_for_approval() throws InterruptedException {
        ...
        this.driver.findElement(By.xpath("//textarea[@id='mat-input-3']")).sendKeys(new CharSequence[]{"Approved By Jaga State Client"});
        this.driver.findElement(By.xpath("//button[@class='mat-focus-indicator btn-1 mat-button mat-button-base mat-primary']")).click();
        Thread.sleep(12000L);
    }
    ...
    public void login_to_candidate_and_validate_approved_status() throws InterruptedException, IOException {
        ...
        TakesScreenshot ts = (TakesScreenshot)this.driver;
        File src = (File)ts.getScreenshotAs(OutputType.FILE);
        File trg = new File(".\\screenshots\\MSER6Application Approved by TP.png");
        FileUtils.copyFile(src, trg);
    }
    ...
    public void validate_Added_to_cart_Successfully_Message() throws InterruptedException, IOException {
        TakesScreenshot ts = (TakesScreenshot)this.driver;
        File src = (File)ts.getScreenshotAs(OutputType.FILE);
        File trg = new File(".\\screenshots\\MSER6_Exam_Added_toCart.png");
        FileUtils.copyFile(src, trg);
    ...
    public void validateExamBookedSuccessfullyMessage() throws InterruptedException, IOException {
        ...
        TakesScreenshot ts = (TakesScreenshot)this.driver;
        File src = (File)ts.getScreenshotAs(OutputType.FILE);
        File trg = new File(".\\screenshots\\MSER6_Exam Booked.png");
        FileUtils.copyFile(src, trg);
    ...
    public void validate_Status_shoud_be_changed_to_Exam_scheduled_in_Exam_Schedule_Board() throws IOException, InterruptedException {
        ...
        TakesScreenshot ts = (TakesScreenshot)this.driver;
        File src = (File)ts.getScreenshotAs(OutputType.FILE);
        File trg = new File(".\\screenshots\\MSER6_ExamScheduled.png");
        FileUtils.copyFile(src, trg);
        Thread.sleep(1000L);
    }
    ...
    public void click_on_Dashboard_and_take_the_screen_shot_of_it() throws IOException, InterruptedException {
        ...
        TakesScreenshot ts = (TakesScreenshot)this.driver;
        File src = (File)ts.getScreenshotAs(OutputType.FILE);
        File trg = new File(".\\screenshots\\MSER6_Exam_Dashboard.png");
        FileUtils.copyFile(src, trg);
    }
