...
public class StepER8 {
    ...
    public void click_on_Start_New_Application() throws IOException {
        ...
        File trg = new File(".\\screenshots\\homepage_MSER8.png");
        FileUtils.copyFile(src, trg);
    }

    @And("Click on Eligibility Route{int}")
    public void clickOnEligibilityRoute(int arg0) throws IOException {
        this.driver.findElement(By.xpath("//body//exai-root//button[7]")).click();
        TakesScreenshot ts = (TakesScreenshot)this.driver;
        File src = (File)ts.getScreenshotAs(OutputType.FILE);
        File trg = new File(".\\screenshots\\MSER8_ER_Validation.png");
        FileUtils.copyFile(src, trg);
    }
    ...
    @When("Candidate Fill the Application Form_SECTION1_UPLOAD TRANSCRIPT_Please upload a copy of your college transcript showing successful completion of the fundamentals_basic nursing skills section of a state approved LPN or RN program within the past twenty-four months")
    public void candidate_fill_the_application_form_section1_upload_transcript_please_upload_a_copy_of_your_college_transcript_showing_successful_completion_of_the_fundamentals_basic_nursing_skills_section_of_a_state_approved_lpn_or_rn_program_within_the_past_twenty_four_months() throws InterruptedException, IOException {
    ...
    @When("Candidate Fill the Application Form_SECTION {int}_Please upload letter from course instructor on school letterhead")
    public void candidate_fill_the_application_form_section__please_upload_letter_from_course_instructor_on_school_letterhead(Integer int1) throws InterruptedException, IOException

    {

        WebElement uploaddocument = this.driver.findElement(By.xpath("//dynamic-material-form-control[4]//div[1]//exai-dynamic-file-upload-control[1]//exai-file-upload-control[1]//div[1]//button[1]"));
        uploaddocument.click();
        Thread.sleep(1000L);
        Runtime.getRuntime().exec("C:\\Autoitfile\\fileupload.exe D:\\Document\\Noodles-MSLocations_Address.pdf");
        Thread.sleep(1000L);
    ...
    public void select_ACCOMMODATIONS_as_No() throws InterruptedException {
        ...
        Thread.sleep(800L);
        this.driver.findElement(By.xpath("//label[@for='mat-radio-12-input']//span[@class='mat-radio-inner-circle']")).click();
...
////label[@for='mat-radio-35-input']//span[@class='mat-radio-inner-circle']
    ...
    public void candidate_can_view_confirmation_message(String string) throws InterruptedException, IOException {
        TakesScreenshot ts = (TakesScreenshot)this.driver;
        File src = (File)ts.getScreenshotAs(OutputType.FILE);
        File trg = new File(".\\screenshots\\MSER8_AppSubmitted_CR.png");
        FileUtils.copyFile(src, trg);
    }
    ...
    public void click_on_approve_button_for_approval() throws InterruptedException {
        ...
        Thread.sleep(1000L);
        this.driver.findElement(By.xpath("//textarea[@id='mat-input-1']")).sendKeys(new CharSequence[]{"Approved By Jaga State Client"});
        this.driver.findElement(By.xpath("//button[@class='mat-focus-indicator btn-1 mat-button mat-button-base mat-primary']")).click();
        Thread.sleep(12000L);
    }
    ...
    public void login_to_candidate_and_validate_approved_status() throws InterruptedException, IOException {
        ...
        TakesScreenshot ts = (TakesScreenshot)this.driver;
        File src = (File)ts.getScreenshotAs(OutputType.FILE);
        File trg = new File(".\\screenshots\\MSER8Application Approved by TP.png");
        FileUtils.copyFile(src, trg);
    }
    ...
    public void validate_Added_to_cart_Successfully_Message() throws InterruptedException, IOException {
        TakesScreenshot ts = (TakesScreenshot)this.driver;
        File src = (File)ts.getScreenshotAs(OutputType.FILE);
        File trg = new File(".\\screenshots\\MSER8_Exam_Added_toCart.png");
        FileUtils.copyFile(src, trg);
    ...
    public void validateExamBookedSuccessfullyMessage() throws InterruptedException, IOException {
        ...
        TakesScreenshot ts = (TakesScreenshot)this.driver;
        File src = (File)ts.getScreenshotAs(OutputType.FILE);
        File trg = new File(".\\screenshots\\MSER8_Exam Booked.png");
        FileUtils.copyFile(src, trg);
    ...
    public void validate_Status_shoud_be_changed_to_Exam_scheduled_in_Exam_Schedule_Board() throws IOException, InterruptedException {
        ...
        TakesScreenshot ts = (TakesScreenshot)this.driver;
        File src = (File)ts.getScreenshotAs(OutputType.FILE);
        File trg = new File(".\\screenshots\\MSER8_ExamScheduled.png");
        FileUtils.copyFile(src, trg);
        Thread.sleep(1000L);
    }
    ...
    public void click_on_Dashboard_and_take_the_screen_shot_of_it() throws IOException, InterruptedException {
        ...
        TakesScreenshot ts = (TakesScreenshot)this.driver;
        File src = (File)ts.getScreenshotAs(OutputType.FILE);
        File trg = new File(".\\screenshots\\MSER8_Exam_Dashboard.png");
        FileUtils.copyFile(src, trg);
    }
